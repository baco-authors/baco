...
class YtOptRunner:
    ...
    def run(self, configurations: List[Tuple[Any]]):
        ...
        feasible_data_array = self.baco_space.run_configurations(self.baco_mode, feasible_configurations, self.beginning_of_time, "ytopt_nonsense_file.csv", black_box_function=self.black_box_function, run_directory=self.run_directory)
